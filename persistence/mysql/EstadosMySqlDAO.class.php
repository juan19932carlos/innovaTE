...
class EstadosMySqlDAO implements EstadosDAO{
	...
	public function insert($estado){
		$sql = 'INSERT INTO estados (descripcion) VALUES (?)';
		$sqlQuery = new SqlQuery($sql);
		
		$sqlQuery->set($estado->descripcion);
	...
	public function update($estado){
		$sql = 'UPDATE estados SET descripcion = ? WHERE nombre = ?';
		$sqlQuery = new SqlQuery($sql);
	...
	public function queryByDescripcion($value){
		$sql = 'SELECT * FROM estados WHERE descripcion = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function deleteByDescripcion($value){
		$sql = 'DELETE FROM estados WHERE descripcion = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
